...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query, DocumentStatus status = DocumentStatus::ACTUAL) const {
        ...
        else return  FindTopDocuments(raw_query, [](int document_id, DocumentStatus status, int rating)
            { return status == DocumentStatus::ACTUAL; });
    }

    template <typename doc_status>
    vector<Document> FindTopDocuments(const string& raw_query, doc_status stat) const {
...
private:
    ...
    template <typename doc_status>
    vector<Document> FindAllDocuments(const Query& query, doc_status stat) const {
